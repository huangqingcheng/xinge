...
var (
    ...
    createMultiMessageUrl = fmt.Sprintf("http://%s/%s/push/create_multipush", apiDomain, apiVersion)
    multiDeviceUrl        = fmt.Sprintf("http://%s/%s/push/device_list_multiple", apiDomain, apiVersion)
